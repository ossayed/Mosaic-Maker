...
public:
  ...
  /* nearest neighbor function.                                     */
    ...
    */
    ...
    RGBAPixel findNearestNeighborHelper(const RGBAPixel & query,int start,int end, int d) const;

    double distance(const RGBAPixel& pixa, const RGBAPixel& pixb) const;
